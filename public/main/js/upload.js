			...
			if (theFile.type.match(imageType)) {
				...
				$.ajax({
				  ...
				  success: function(data, status) {
		    		...
		    		var quick = "<div class='side-item goto-item' data-goto='"+data+"'>";
		    		quick = quick + "<h5>New Snippet</h5>";
		    		quick = quick + "<h6>" + the_lang + "</h6></div>";
		    		
		    		$(".sidebar-list").html($(".sidebar-list").html() + quick);
