...
function responsive(){
	if($(window).width() < 833){
		...
		$(".snipbar").css("width","100%");
		
		$(".snipbar").css("z-index","1");
		$(".sidebar").css("z-index","-1");
		
	}
	else{
	
		$("paper-icon-button[icon='new']").css("display","inline-block");
		//large
		$(".sidebar").css("width","34%");
		$(".snipbar").css("width","66%");
		
		$(".snipbar").css("z-index","0");
		$(".sidebar").css("z-index","0");
	}
	
	if($(window).width() < 640){
		$("paper-icon-button[icon='add']").css("display","none");
		$(".email").css("display","none");
	}
	else{
		$("paper-icon-button[icon='add']").css("display","inline-block");
